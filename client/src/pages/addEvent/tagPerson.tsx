...
export const TagPerson = (props: TagPersonProps) => {
  ...
  const { data, loading, error } = useQuery<GUIDsByNameResult, GUIDsByNameVars>(
    GET_GUIDS_BY_NAME,
    { variables: { name: personTagName } }
  );
  const results =
    data?.GetGUIDsByName.summaries.filter(
    ...
    <>
      ...
      <List>
        ...
        {loading ? (
              ...
              >
                {entity.guid === newPersonGUID ? (
                  <>
                    ...
                    <Paper>
                      <Typography>
                        Create new entity from name: {entity.names}
                      </Typography>
                    </Paper>
                  </>
                ) : (
                  ...
                  <Paper>
                    ...
                    <ListItemText>
                      Appears in {entity.citation_count} Citations
                    </ListItemText>
                    <br />
                    <ListItemText>
                      Date of earliest citation: {entity.first_citation_date}
                    </ListItemText>
                    <br />
                    <ListItemText>
                      Date of latest citation: {entity.last_citation_date}
                    </ListItemText>
                  </Paper>
                )}
              </ListItemButton>
          ...
          <ListItem>
            <ListItemText>Please search for person by name</ListItemText>
          </ListItem>
        )}
      </List>
    </>
  ...
  return (
    <Box>
      <Paper>{showSearchResults ? searchResults : searchBar}</Paper>
    </Box>
  );
};
