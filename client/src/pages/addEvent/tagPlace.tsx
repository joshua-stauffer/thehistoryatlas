...
import {
  ...
  CoordinatesByNameResult,
  CoordinatesByNameVars,
} from "../../graphql/getCoordinatesByName";
import {
  GET_PLACE_BY_COORDS,
  GetPlaceByCoordsResult,
  GetPlaceByCoordsVars,
} from "../../graphql/getPlaceByCoords";
...
export const TagPlaceHelper = (props: TagPlaceProps) => {
  ...
  const {
    ...
    GET_PLACE_BY_COORDS,
    {
      variables: {
        ...
        longitude: currentEntity?.longitude
          ? currentEntity.longitude
          : longitude,
      },
    }
  );
  ...
  useEffect(() => {
    ...
    setCurrentEntity((entity) => {
      if (!entity) return entity;
      const guid = placeByCoordsData.GetPlaceByCoords.guid
        ? placeByCoordsData.GetPlaceByCoords.guid
        : newPlaceGUID;
      return {
        ...entity,
        guid: guid,
