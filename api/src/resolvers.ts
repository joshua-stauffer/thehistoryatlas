  ...
  Query: {
    ...
    GetUser: async (
      ...
      try {
        ...
        const response = (await queryAccounts(msg)) as
          | Accounts.GetUserResult
    ...
    IsUsernameUnique: async (
      ...
      try {
        ...
        const response = (await queryAccounts(msg)) as
          | Accounts.IsUsernameUniqueResult
          | Accounts.ErrorResponse;
        const payload = handleErrors(response);
        console.debug("received result: ", payload);
        return payload;
  ...
  Mutation: {
    ...
    DeactivateAccount: async (
      ...
      try {
        ...
        const response = (await queryAccounts(msg)) as
          | Accounts.DeactivateAccountResult
          | Accounts.ErrorResponse;
        const payload = handleErrors(response);
        console.debug("received result: ", payload);
        return payload;
