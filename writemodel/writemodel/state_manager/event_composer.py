...
class EventComposer:
    def __init__(
        self, transaction_guid: str, app_version: str, user: str, timestamp: str
    ) -> None:
        ...
        log.debug(
            f"Created new EventComposer for transaction {transaction_guid} by user {user}"
        )
