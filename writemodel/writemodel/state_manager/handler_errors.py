...
class UnknownCommandTypeError(CommandHandlerError):
    def __init__(
        self,
        msg="Command with an unknown or poorly formed type "
...
class MalformedEventError(EventHandlerError):
    def __init__(
        self,
        msg=" Event with a poorly formatted body " + "was passed to the EventHandler",
    ):
...
class UnknownEventTypeError(EventHandlerError):
    def __init__(
        self,
        msg="Event with an unknown or poorly formed type "
