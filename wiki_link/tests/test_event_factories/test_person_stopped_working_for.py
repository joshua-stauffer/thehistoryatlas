            ...
            EMPLOYER: [
                {
                    ...
                    "qualifiers": {
                        END_TIME: [create_time_claim("+1990-01-01T00:00:00Z", 11)]
                    },
                }
            ]
        },
            ...
            EMPLOYER: [
                {
                    ...
                    "qualifiers": {
                        END_TIME: [create_time_claim("+1990-01-01T00:00:00Z", 10)],
                        POSITION_HELD: [
                            {
                                "snaktype": "value",
...
@pytest.fixture
def mock_entity_with_employer_no_end_time() -> Entity:
    return Entity(
        id="Q54321",
        pageid=54321,
        ns=0,
...
class TestPersonStoppedWorkingFor:
    ENTITY_LOOKUP = {
    ...
    def test_entity_has_event_success(self, mock_entity_with_employer: Entity) -> None:
        ...
        factory = PersonStoppedWorkingFor(entity=mock_entity_with_employer, query=query)
    ...
    def test_entity_has_event_no_end_time(
        self, mock_entity_with_employer_no_end_time: Entity
    ) -> None:
        query = create_autospec(Query)
        factory = PersonStoppedWorkingFor(
            entity=mock_entity_with_employer_no_end_time, query=query
        )
        assert not factory.entity_has_event()
    ...
    def test_create_wiki_event_basic(
        ...
        assert (
            wiki_event.summary
            == "On January 1, 1990, John Doe stopped working for ACME Corporation."
        )
    ...
    def test_create_wiki_event_with_role(
        ...
        assert (
            wiki_event.summary
            == "On January 1, 1990, John Doe stopped working for ACME Corporation as Software Engineer."
        )
    ...
    def test_create_wiki_event_with_position(
        ...
        assert (
            wiki_event.summary
            == "John Doe stopped working for ACME Corporation as Software Engineer in January 1990."
        )
