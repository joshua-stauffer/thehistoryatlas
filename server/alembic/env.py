...
# Import the models
from the_history_atlas.apps.history.schema import Base as HistoryBase
...
target_metadata = [HistoryBase.metadata, AccountsBase.metadata]
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            target_metadata=target_metadata,
            compare_type=True,  # Compare column types when generating migrations
        )
